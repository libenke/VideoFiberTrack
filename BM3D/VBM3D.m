function [y_hat_wi,PSNR_FINAL_ESTIMATE] = VBM3D(Xnoisy, sigma,bm3dProfile, NumberOfFrames, dump_information, Xorig)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
N2                  = 32;  %% maximum number of similar blocks (maximum size of the 3rd dimension of the 3D groups)
Ns                  = 20;  %% length of the side of the search neighborhood for full-search block-matching (BM)
Npr                 = 20;  %% length of the side of the motion-adaptive search neighborhood, use din the predictive-search BM
